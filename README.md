...
[![CI](https://github.com/j-marcon/opencode-side-panel-sessions/actions/workflows/ci.yml/badge.svg)](https://github.com/j-marcon/opencode-side-panel-sessions/actions/workflows/ci.yml)
...
2. **Push the tag:**
   ...
   The [publish workflow](.github/workflows/publish.yml) will run typecheck, build, and publish to npm automatically.
...
The publish workflow requires an `NPM_TOKEN` secret in your GitHub repository settings. Create an npm automation token with publish access to the `opencode-side-panel-sessions` package and add it to [repository secrets](https://github.com/j-marcon/opencode-side-panel-sessions/settings/secrets/actions).
